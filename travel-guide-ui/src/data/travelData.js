export const destinations = [
  {
    ...
    location: '昆明 · 亚洲最大花市',
    desc: '5元实现鲜花自由，直接寄回家',
    image: 'https://cdn.jsdelivr.net/gh/Krwaby123/travel-assets-yn@main/images/spots/dounan.webp'
  },
  {
    id: 'dali',
    goto: 2,
    ...
    image: 'https://cdn.jsdelivr.net/gh/Krwaby123/travel-assets-yn@main/images/spots/dali.webp'
  },
  {
    id: 'lijiang',
    goto: 3,
    ...
    location: '古城 · 玉龙雪山',
    desc: '雪山积雪完整，蓝月谷澄澈',
    image: 'https://cdn.jsdelivr.net/gh/Krwaby123/travel-assets-yn@main/images/spots/lijiang.webp'
  },
  {
    id: 'shangri',
    goto: 4,
    ...
    location: '藏地 · 古城转经筒',
    desc: '高原藏地人文，雪山湖泊草甸',
    image: 'https://cdn.jsdelivr.net/gh/Krwaby123/travel-assets-yn@main/images/spots/shangri.webp'
  }
]
...
export const dounanData = {
  ...
  photos: [
    { src: 'https://cdn.jsdelivr.net/gh/Krwaby123/travel-assets-yn@main/images/spots/dounan-1-huahai.webp', label: '花海' },
    { src: 'https://cdn.jsdelivr.net/gh/Krwaby123/travel-assets-yn@main/images/spots/dounan-2-pifa.webp', label: '批发盛况' },
    { src: 'https://cdn.jsdelivr.net/gh/Krwaby123/travel-assets-yn@main/images/spots/dounan-3-durou.webp', label: '多肉天堂' }
  ],
  timeTable: {
    rows: [
  ...
  spots: [
    {
      ...
      booking: '无需预约',
      photos: [
        { src: 'https://cdn.jsdelivr.net/gh/Krwaby123/travel-assets-yn@main/images/spots/dali-gucheng-1-beimen-yinghua.webp', label: '北门樱花巷' },
        { src: 'https://cdn.jsdelivr.net/gh/Krwaby123/travel-assets-yn@main/images/spots/dali-gucheng-2-wuhualou.webp', label: '五华楼夜景' },
        { src: 'https://cdn.jsdelivr.net/gh/Krwaby123/travel-assets-yn@main/images/spots/dali-gucheng-3-yangrenjie.webp', label: '洋人街' }
      ]
    },
    {
      name: '喜洲古镇',
      ...
      photos: [
        { src: 'https://cdn.jsdelivr.net/gh/Krwaby123/travel-assets-yn@main/images/spots/xizhou-corner.webp', label: '转角楼' },
        { src: 'https://cdn.jsdelivr.net/gh/Krwaby123/travel-assets-yn@main/images/spots/xizhou-1-yangjiadeng.webp', label: '杨家登油菜花' },
        { src: 'https://cdn.jsdelivr.net/gh/Krwaby123/travel-assets-yn@main/images/spots/xizhou-2-xilinyuan.webp', label: '喜林苑黄墙' }
      ]
    },
    {
      name: '洱海生态廊道',
      ...
      photos: [
        { src: 'https://cdn.jsdelivr.net/gh/Krwaby123/travel-assets-yn@main/images/spots/erhai-1-longkan.webp', label: '龙龛码头' },
        { src: 'https://cdn.jsdelivr.net/gh/Krwaby123/travel-assets-yn@main/images/spots/erhai-2-panxi.webp', label: '磻溪S湾' },
        { src: 'https://cdn.jsdelivr.net/gh/Krwaby123/travel-assets-yn@main/images/spots/erhai-3-caicun.webp', label: '才村码头' }
      ]
    },
    {
      name: '双廊古镇',
      ...
      booking: '无需预约',
      photos: [
        { src: 'https://cdn.jsdelivr.net/gh/Krwaby123/travel-assets-yn@main/images/spots/shuanglang-1-yujiidao.webp', label: '玉几岛' },
        { src: 'https://cdn.jsdelivr.net/gh/Krwaby123/travel-assets-yn@main/images/spots/shuanglang-2-riluo.webp', label: '日落观景台' },
        { src: 'https://cdn.jsdelivr.net/gh/Krwaby123/travel-assets-yn@main/images/spots/shuanglang-3-kafeiguan.webp', label: '海景咖啡馆' }
      ]
    }
  ],
  routeDetail: {
...
export const lijiangData = {
  ...
  coverImage: {
    src: 'https://cdn.jsdelivr.net/gh/Krwaby123/travel-assets-yn@main/images/spots/lijiang-lanyuegu.webp',
    caption: '玉龙雪山 · 蓝月谷'
  },
  venues: [
...
export const shangriData = {
  ...
  coverImage: {
    src: 'https://cdn.jsdelivr.net/gh/Krwaby123/travel-assets-yn@main/images/spots/shangri-rizhaoshan.webp',
    caption: '梅里雪山 · 日照金山'
  },
  venues: [
